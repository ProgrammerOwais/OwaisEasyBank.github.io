...
const Footer = () => {
  return (
    <footer>
      <div className="foot-row content-div">
        ...
        <div className="foot-col foot-col4">
          <div className="foot-btn-div">
            <button className="invite-btn foot-btn">Request Invite</button>
          </div>
          <p className="foot-para">&copy; EasyBank. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
