import mobImg from "./mob.png";

const Section1 = () => {
  return (
    <div className="section1">
      <img alt="img" src={mobImg} className="sec1-mobile-img" />
      <div className="sec1-col sec1-col1">
        <div className="sec1-div">
          <h2 className="sec1-heading">Next generation digital banking</h2>
          <p className="para sec1-para">
            Take your financial life online. Your Easybank account will be a
            one-stop-shop for spending, saving, budgeting, investing and much
            more.
          </p>
          <button className="invite-btn sec1-btn">Request Invite</button>
        </div>
      </div>
      <div className="sec1-col sec1-col2">
        <svg
          className="sec1-img sec1-img1"
